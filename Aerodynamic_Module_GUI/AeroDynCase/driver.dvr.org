...
DTU 10.0 MW onshore baseline
-----  Input Configuration  ----------------------------------------------------
True          Echo            -  Echo input parameters to "<rootname>.ech"?
"input.dat"    AD_InputFile    -  Name of the primary AeroDyn input file
-----  Turbine Data  -----------------------------------------------------------
          3   NumBlades       - Number of blades (-)
        2.8   HubRad          - Hub radius (m)
        119   HubHt           - Hub height (m)
       -7.7   Overhang        - Overhang (m)
         0   ShftTilt        - Shaft tilt (deg)
         -2.5   Precone         - Blade precone (deg)
-----  I/O Settings  -----------------------------------------------------------
"Test014"      OutFileRoot     - Root name for any output files (use "" for .dvr rootname) (-)
